                            ...
                            pcall(function()
                                ...
                                for i = 2, 10 do
                                    ...
                                    if (getgenv().TreasureAutoFarm.SpeedTier or 2) < 3 and (i == 3 or i == 6 or i == 9 or i == 10) then
                                        ...
                                        hybridMoveTo(Vector3.new(stagePos.X - 18, 85, stagePos.Z), false)
                                        hybridMoveTo(Vector3.new(stagePos.X, 85, stagePos.Z + 18), false)
                                        hybridMoveTo(Vector3.new(stagePos.X, 85, stagePos.Z - 18), false)
                                    end
                                end
                                ...
                                if getgenv().TreasureAutoFarm.Mode == "Fly-TP" then
                                    ...
                                    pcall(function() 
                                        UI.SR.Text = "Runs Completed: " .. tostring(getgenv().AF_TotalRuns)
                                        UI.SGld.Text = "Gold Earned: ~" .. tostring(getgenv().AF_TotalGold) 
                                    end)
                                    hum.Health = 0

        ...
        if getgenv().AF_TI and getgenv().AF_TI.Text == "Антифрикбог" then 
            ...
            UI.AFK.MouseButton1Click:Connect(function()
                ...
                if getgenv().AF_AntiAFK then
                    UI.AFK.Text = "🛡️ TOGGLE ANTI-AFK: ON"; UI.AFK.TextColor3 = Color3.fromRGB(120, 255, 120); UI.AFKS.Color = Color3.fromRGB(55, 110, 55)
                else
                    UI.AFK.Text = "🛡️ TOGGLE ANTI-AFK: OFF"; UI.AFK.TextColor3 = Color3.fromRGB(255, 120, 120); UI.AFKS.Color = Color3.fromRGB(110, 55, 55)
                end
            end)
            ...
            if getgenv().AF_TI then getgenv().AF_TI.Text = ""; getgenv().AF_TI.PlaceholderText = "Wrong Password!" end
        end
    end)
                end
                task.spawn(function()
    while task.wait(0.5) do
        if getgenv().AF_PassVerified and getgenv().AF_MainData then
            local UI = getgenv().AF_MainData
            local LP = game:GetService("Players").LocalPlayer

...
AuthGui.Name = "AntiFreak_Auth"
AuthGui.ResetOnSpawn = false
AuthGui.Parent = LocalPlayer:WaitForChild("PlayerGui")

local AuthFrame = Instance.new("Frame")
AuthFrame.Size = UDim2.new(0, 260, 0, 150)
AuthFrame.Position = UDim2.new(0.4, 0, 0.4, 0)
AuthFrame.BackgroundColor3 = Color3.fromRGB(15, 12, 22)
...
AuthStroke.Color = Color3.fromRGB(140, 80, 255)
...
AuthTitle.TextColor3 = Color3.fromRGB(180, 120, 255)
AuthTitle.TextSize = 14
AuthTitle.Font = Enum.Font.GothamBold
AuthTitle.Parent = AuthFrame
local PasswordInput = Instance.new("TextBox")
PasswordInput.Size = UDim2.new(0, 200, 0, 35)
PasswordInput.Position = UDim2.new(0.5, -100, 0.35, 0)
PasswordInput.BackgroundColor3 = Color3.fromRGB(24, 20, 32)
PasswordInput.Text = ""
PasswordInput.PlaceholderText = "Password here..."
PasswordInput.TextColor3 = Color3.fromRGB(255, 255, 255)
PasswordInput.PlaceholderColor3 = Color3.fromRGB(100, 90, 120)
PasswordInput.TextSize = 12
PasswordInput.Font = Enum.Font.Gotham
PasswordInput.Parent = AuthFrame
Instance.new("UICorner", PasswordInput).CornerRadius = UDim.new(0, 6)

local LoginBtn = Instance.new("TextButton")
LoginBtn.Size = UDim2.new(0, 200, 0, 35)
LoginBtn.Position = UDim2.new(0.5, -100, 0.65, 0)
LoginBtn.BackgroundColor3 = Color3.fromRGB(140, 75, 255)
LoginBtn.Text = "LOGIN"
